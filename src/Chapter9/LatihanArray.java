...
public class LatihanArray {
    public static void main(String[] args) {
        int[] arrayAngka1 = {5,7,453,63,6,7,35,22,42,52};
        int[] arrayAngka2 = {0,4,544,45,3,4,32,44,12,00};
        ...
        for (int i = 0; i < arrayAngka2.length;i++) {
            ...
            //Sorting reverse, mengurutkan dengam kabalik

        printArray(arrayAngka1,"array 1");
        // Arrays.sort(arrayAngka1);
        // printArray(arrayAngka1,"sorted ");

      //   int[] arrayBuffer =Arrays.copyOf(arrayAngka1, arrayAngka1.length);
      //  for (int i = 0; i < arrayAngka1.length;i++){
        //    arrayAngka1[i] = arrayBuffer[(arrayBuffer.length - 1) - i];
      //  }
        reverse(arrayAngka1);
        printArray(arrayAngka1,"reverse 2");
